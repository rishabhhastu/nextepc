...
static asn_TYPE_member_t asn_MBR_S1AP_ThresholdEventA2_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_ThresholdEventA2, iE_Extensions),
		...
		&asn_DEF_ProtocolExtensionContainer_5964P68,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"iE-Extensions"
...
static const int asn_MAP_S1AP_ThresholdEventA2_oms_1[] = { 1 };
static const ber_tlv_tag_t asn_DEF_S1AP_ThresholdEventA2_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_S1AP_ThresholdEventA2_tag2el_1[] = {
