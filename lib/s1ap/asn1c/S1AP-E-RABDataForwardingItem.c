...
static asn_TYPE_member_t asn_MBR_S1AP_E_RABDataForwardingItem_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct S1AP_E_RABDataForwardingItem, uL_S1AP_TransportLayerAddress),
	...
	{ ATF_POINTER, 2, offsetof(struct S1AP_E_RABDataForwardingItem, uL_S1AP_GTP_TEID),
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_E_RABDataForwardingItem, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_5964P0,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"iE-Extensions"
...
static const asn_TYPE_tag2member_t asn_MAP_S1AP_E_RABDataForwardingItem_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* uL-S1AP-TransportLayerAddress */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* uL-S1AP-GTP-TEID */
