...
static asn_TYPE_member_t asn_MBR_S1AP_E_RABModifyItemBearerModRes_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_E_RABModifyItemBearerModRes, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_5964P9,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"iE-Extensions"
...
static asn_SEQUENCE_specifics_t asn_SPC_S1AP_E_RABModifyItemBearerModRes_specs_1 = {
