...
static asn_TYPE_member_t asn_MBR_S1AP_TargeteNB_ID_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct S1AP_TargeteNB_ID, global_S1AP_ENB_ID),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct S1AP_TargeteNB_ID, selected_S1AP_TAI),
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_TargeteNB_ID, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_5964P65,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"iE-Extensions"
