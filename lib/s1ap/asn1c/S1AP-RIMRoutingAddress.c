...
static asn_per_constraints_t asn_PER_type_S1AP_RIMRoutingAddress_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  0,  0,  0l,  0l }	/* (0..0,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_S1AP_RIMRoutingAddress_1[] = {
...
static asn_CHOICE_specifics_t asn_SPC_S1AP_RIMRoutingAddress_specs_1 = {
