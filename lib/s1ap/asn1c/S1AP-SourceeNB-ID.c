...
static asn_TYPE_member_t asn_MBR_S1AP_SourceeNB_ID_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct S1AP_SourceeNB_ID, global_S1AP_ENB_ID),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct S1AP_SourceeNB_ID, selected_S1AP_TAI),
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_SourceeNB_ID, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_5964P54,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"iE-Extensions"
...
static const asn_TYPE_tag2member_t asn_MAP_S1AP_SourceeNB_ID_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* global-S1AP-ENB-ID */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* selected-S1AP-TAI */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* iE-Extensions */
};
static asn_SEQUENCE_specifics_t asn_SPC_S1AP_SourceeNB_ID_specs_1 = {
