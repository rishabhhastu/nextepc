...
static asn_TYPE_member_t asn_MBR_S1AP_UEContextReleaseRequest_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct S1AP_UEContextReleaseRequest, protocolIEs),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolIE_Container_5903P23,
...
static asn_SEQUENCE_specifics_t asn_SPC_S1AP_UEContextReleaseRequest_specs_1 = {
